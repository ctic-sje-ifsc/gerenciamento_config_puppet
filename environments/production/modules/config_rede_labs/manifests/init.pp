...
##DEPENDENCIA DE PACOTES
	...
	case $hostname {
		...
		"sj-redes1-d1.sj.ifsc.edu.br": {$interface = 'puppet:///modules/config_rede_labs/interfaces.prof.redes1'}
		"sj-redes1-d1": {$interface = 'puppet:///modules/config_rede_labs/interfaces.prof.redes1'}
