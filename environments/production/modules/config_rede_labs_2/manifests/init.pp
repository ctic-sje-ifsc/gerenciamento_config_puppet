...
##DEPENDENCIA DE PACOTES
  ...
  #}
	...
	case $hostname {
		"sj-labinf-36798": {$interface = 'puppet:///modules/config_rede_labs_2/interfaces.prof.informatica'}
		"sj-labinf-36798.sj.ifsc.edu.br": {$interface = 'puppet:///modules/config_rede_labs_2/interfaces.prof.informatica'}
