...
if $::kernel == windows {
	...
	if $lsbdistcodename == trusty {
		#PACOTES NECESSARIOS
		$list = [ "libnss-ldap", "libpam-ldap", "ldap-utils", "nscd", "smbclient", "libpam-mount", "libpam-ccreds", "nss-updatedb", "pam-kwallet", "smbnetfs", "cifs-utils", "ldap-auth-config", "ldap-auth-client",  "auth-client-config", "keyutils", "libcryptsetup4", "libhx28" ]
  	package { $list:
		ensure => latest,
